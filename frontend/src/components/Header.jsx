...
function Header({ onCompareToggle, isCompareMode, onSettingsOpen, onHowItWorksOpen, onApiDocsOpen, onDiffOpen, onBatchOpen, onTeacherOpen, onAdminOpen, onWordCounterOpen, onTransformerOpen, currentView }) {
  ...
  return (
    <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 shadow-sm no-print relative overflow-visible">
      {/* #38 — Animated gradient accent */}
      <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-primary-500 via-blue-500 to-primary-500 animate-gradient-x overflow-hidden" />
